...
namespace HellsGorge.Generation
{
    public class OreGeneration : ModWorld
    {
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                tasks.Insert(ShiniesIndex + 1, new PassLegacy("IHGOres", delegate (GenerationProgress progress)
                {
                    progress.Message = "Generating  IHGOres";
